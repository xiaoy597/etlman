...
export ETL_METADB_SERVER=localhost:3306
export ETL_METADB_DBNAME=chain_cfg
export ETL_METADB_USER=root
export ETL_METADB_PASSWORD=123456

export ETL_ZIPPER_DEBUG=true
export ETL_ZIPPER_PARTITION=512
...
spark-submit \
	...
	--jars $DEPS \
	etlman-1.0-SNAPSHOT.jar cluster $SCHEMA_NAME $TABLE_NAME $LOAD_MONTH $START_DATE $END_DATE $DEFAULT_END_DATE $ZIP_DBNAME 1>${LOG_FILE} 2>&1
