...
echo "Clearing previous check result ..."
sh clear-dqc.sh
echo "Complete"
...
export DQC_DB_SERVER=59.212.226.51
export DQC_DB_PORT=3306
export DQC_DB_USER=root
export DQC_DB_PASSWORD=123456
...
LOG_FILE=dqc-run_${CURR_TIME}.log

echo "Please wait ..."
echo

java -classpath "./etlman-1.0-SNAPSHOT.jar:$DEPS" io.jacob.etlman.dqcheck.DQCheckRunner $DQC_DB $WORKDATE $WORKDIR $DEBUG_MODE 1>${LOG_FILE} 2>&1
